...
const SignIn = props => {
  ...
  return (
    <ScrollView>
      <Image style={styles.iconBack} source={require('./images/Arrow.png')} />
      ...
      <View style={styles.viewPW}>
        <TextInput
          ...
          placeholderTextColor={'#AC8E71'}
        />
        <Image style={styles.imgPW} source={require('./images/ion_eye.png')} />
      </View>

      <Text style={styles.textForgot}>Forgote Password</Text>

      <Pressable onPress={handleSignIn} style={styles.stylePress}>
